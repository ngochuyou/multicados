...
/**
 * Strategy for building {@link DomainResourceAttributesMetadata}
 *
 *
 * @author Ngoc Huy
 *
...
public interface DomainResourceMetadataBuilder {
	 ...
	 *                         {@link DomainResourceAttributesMetadata}. Metadata-s
	 *                         in this cache are required to be built top-down
	 *                         regarding the inheritance tree
	 * @return
	 * @throws Exception
	 */
