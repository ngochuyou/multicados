...
/**
 * A contract in describing attributes of a {@link DomainResource} type
 *
 * @author Ngoc Huy
 *
 * @param <D>
 */
public interface DomainResourceAttributesMetadata<D extends DomainResource> extends DomainResourceMetadata<D> {
	...
	/**
	 * @return the same as
	 *         {@link DomainResourceAttributesMetadata#getAttributeNames()} except
